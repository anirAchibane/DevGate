<template>
    <div id="navbar" class="mini-navbar p-3 rounded-lg">
      <div id="navbar-content" class="nav-items d-flex">
        <div class="ele">
            <div class="nav-item d-flex align-items-center" @click="logout()">
        ...
        <router-link :to="{name: 'Profil', params: {id: auth.currentUser.uid}}" class="navlink">
            <div class="nav-item d-flex align-items-center">
            <div class="nav-icon-wrapper me-2">
